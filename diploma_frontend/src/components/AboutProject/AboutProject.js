    ...
    return (
      <div className="container__about">
            ...
            <div className='gridContainer__about'>
                  <p className='grid__text grid__title__text'>Дипломный проект включал 5 этапов</p>
                  <p className='grid__text grid__title__text'>На выполнение диплома ушло 5 недель</p>
                  <p className='grid__text'>Составление плана, работу над бэкендом, вёрстку, добавление <br/> функциональности и финальные доработки.</p>
            ...
            <div className='gridContainer__weeks'>
                  ...
                  <p className="grid__text__transparent">Back-end</p>
                  <p className="grid__text__transparent">Front-end</p>
            </div>
      </div>    
    );
  }
